...
def get_dockerfile_prompt(repo_url: str = DEFAULT_REPO_URL_FEW_SHOT_EXAMPLE) -> str:
    prompt_dockerfile = f"""
...
def get_sample_script_prompt(repo_url: str = DEFAULT_REPO_URL_FEW_SHOT_EXAMPLE) -> str:
